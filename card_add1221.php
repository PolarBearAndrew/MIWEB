	...
	if ($LayoutBgimgRow != 0) {
		for ($i = 0; $i < $LayoutBgimgRow; ++$i) {
			...
			$paramsDocumentBgimgInsert = array(
				$pageid,
				$LayoutBgimgArray[$i]['objectid'],
				$LayoutBgimgArray[$i]['name'],
				$LayoutBgimgArray[$i]['objectheight'],
				$LayoutBgimgArray[$i]['objectwidth'],
				$LayoutBgimgArray[$i]['objectxpos'],
				$LayoutBgimgArray[$i]['objectypos'],
				$LayoutBgimgArray[$i]['imagepath'],
	...
	if ($LayoutIllimgRow != 0) {
		for ($i = 0; $i < $LayoutIllimgRow; ++$i) {
			...
			$paramsDocumentillimgInsert = array(
				$pageid,
				$LayoutIllimgArray[$i]['objectid'],
				$LayoutIllimgArray[$i]['name'],
				$LayoutIllimgArray[$i]['objectheight'],
				$LayoutIllimgArray[$i]['objectwidth'],
				$LayoutIllimgArray[$i]['objectxpos'],
				$LayoutIllimgArray[$i]['objectypos'],
				$LayoutIllimgArray[$i]['imagepath'],
				$LayoutIllimgArray[$i]['zindex'],
				$LayoutIllimgArray[$i]['cropper'],
				$LayoutIllimgArray[$i]['cutxpos'],
				$LayoutIllimgArray[$i]['cutypos'],
				$LayoutIllimgArray[$i]['cutheight'],
				$LayoutIllimgArray[$i]['cutwidth'],
				$LayoutIllimgArray[$i]['objectkey'],
				$LayoutIllimgArray[$i]['rotation'],
				$LayoutIllimgArray[$i]['objectwarning'],
				$LayoutIllimgArray[$i]['picheight'],
				$LayoutIllimgArray[$i]['picwidth'],
				$LayoutIllimgArray[$i]['reheight'],
				$LayoutIllimgArray[$i]['rewidth'],
				$LayoutIllimgArray[$i]['diycut'],
				$LayoutIllimgArray[$i]['awidth'],
				$LayoutIllimgArray[$i]['aheight']
			);
	...
	if ($LayoutImageRow != 0) {
		for ($i = 0; $i < $LayoutImageRow; ++$i) {
			...
			$paramsDocumentImageInsert = array(
				$pageid,
				$LayoutImageArray[$i]['objectid'],
				$LayoutImageArray[$i]['name'],
				$LayoutImageArray[$i]['objectheight'],
				$LayoutImageArray[$i]['objectwidth'],
				$LayoutImageArray[$i]['objectxpos'],
				$LayoutImageArray[$i]['objectypos'],
				$LayoutImageArray[$i]['imagepath'],
				$LayoutImageArray[$i]['zindex'],
				$LayoutImageArray[$i]['cropper'],
				$LayoutImageArray[$i]['cutxpos'],
				$LayoutImageArray[$i]['cutypos'],
				$LayoutImageArray[$i]['cutheight'],
				$LayoutImageArray[$i]['cutwidth'],
				$LayoutImageArray[$i]['objectkey'],
				$LayoutImageArray[$i]['rotation'],
				$LayoutImageArray[$i]['objectwarning'],
				$LayoutImageArray[$i]['picheight'],
				$LayoutImageArray[$i]['picwidth'],
				$LayoutImageArray[$i]['reheight'],
				$LayoutImageArray[$i]['rewidth'],
				$LayoutImageArray[$i]['diycut'],
				$LayoutImageArray[$i]['awidth'],
				$LayoutImageArray[$i]['aheight']
			);
